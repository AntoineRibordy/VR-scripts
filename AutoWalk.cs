...
public class AutoWalk : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if (walkWhenTriggered && !walkWhenLookDown && !isWalking && gvrViewer.Triggered && !inventory.reticleOnObject && !resourceMining.stopInteracting) 
		{
			isWalking = true;
		} 
		...
		if (walkWhenLookDown && !walkWhenTriggered && !isWalking &&  
			...
			head.transform.eulerAngles.x <= RIGHT_ANGLE && !inventory.reticleOnObject && !resourceMining.stopInteracting) 
		{
			isWalking = true;
		} 
